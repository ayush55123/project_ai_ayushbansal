...
public class MainActivity extends AppCompatActivity {
    ...
    public void newMatch() {  //A game is composed of three matches
      ...
      // Your code here, to diplay correct and incorrect options on the buttons
        ...
        {
            button1.setText(ans + 2 +"");
            button2.setText(ans+1 +"");
            button3.setText(ans-2 +"");
            button4.setText(ans*4 +"");
        }
        else if(correctButton==2)
        {
            button1.setText(ans + 3 +"");
            button2.setText(ans-1 +"");
            button3.setText(ans+3 +"");
            button4.setText(ans*1 +"");
        }
        ...
        if(matchCounter==3){    // if three match
            // es are completed updatee the perfomrance in sharedpreferences
